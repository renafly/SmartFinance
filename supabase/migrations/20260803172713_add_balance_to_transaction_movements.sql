-- Include the running balance in the movement page so callers do not need a
-- second transactions query. Transfer movements use the outgoing/source-side
-- transaction because their displayed amount is the source-account expense.
...
'Lists paginated transaction and completed-transfer movements, including the account balance after the transaction or transfer source transaction.';
