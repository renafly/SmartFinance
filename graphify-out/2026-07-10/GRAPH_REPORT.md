...
## Corpus Check
- 259 files · ~139,362 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1253 nodes · 2737 edges · 100 communities (79 shown, 21 thin omitted)
...
Cohesion: 0.08
Nodes (30): Account, BudgetConfig, BudgetHouseholdSettings, BudgetRule, buildPotAccountMap(), DestinationKind, findHighestCashAccount(), getCashAccountIds() (+22 more)

### Community 7 - "index.ts"
Cohesion: 0.10
Nodes (27): CategoryEditDraft, categoryIconSuggestions, CategoryLike, types, samples, StorybookPreviewScreen(), Badge(), ALL_ICON_NAMES (+19 more)
...
Cohesion: 0.15
Nodes (23): addMonths(), addOccurrence(), buildSavingPotForecasts(), findCompletionDate(), ForecastContribution, ForecastFrequency, ForecastPot, ForecastRule (+15 more)
...
Cohesion: 0.14
Nodes (13): useArchiveAccount(), useCreateAccount(), useDeleteAccount(), useUpdateAccount(), useDeleteHousehold(), useUpdateHousehold(), useCreateTransaction(), useDeleteTransaction() (+5 more)

### Community 16 - "settings.tsx"
Cohesion: 0.11
Nodes (21): AccountGroup, AccountGroupView, AccountOption, createStyles(), PotDraft, PotScope, SelectionMode, currencyOptions (+13 more)
...
Cohesion: 0.27
Nodes (10): AccountLike, getAccountLabel(), getAccountSubtitle(), getMemberLabel(), getOwnerLabel(), GroupedAccountSelect(), GroupedAccountSelectProps, MemberLike (+2 more)
...
Cohesion: 0.13
Nodes (14): CategoriesScreen(), getTypeColor(), getTypeIcon(), useArchiveCategory(), useCategories(), useChildCategories(), useCreateCategory(), useDeleteCategory() (+6 more)

### Community 24 - "selection-shell.tsx"
Cohesion: 0.12
Nodes (33): AccountHistoryMode, accountTypes, createStyles(), currencyOptions, EditMode, AttachmentDraft, createStyles(), DateFilterField() (+25 more)
...
Cohesion: 0.09
Nodes (16): GoogleLoginScreen(), SignOutButton(), AppNotification, AuthService, StorageService, UploadFile, memoryStorage, supabase (+8 more)

### Community 36 - ".importHouseholdBackup"
Cohesion: 0.11
Nodes (11): CreateRecurringTransactionInput, Frequency, RuleKind, TransactionType, UpdateRecurringTransactionInput, createdTransaction, mockCreate, mockDelete (+3 more)
...
Cohesion: 0.25
Nodes (11): AccountsScreen(), getTransactionTypeIcon(), TransactionsScreen(), useTopLevelCategories(), useDefaultHousehold(), useMyHouseholds(), useSetDefaultHousehold(), useHouseholdMemberDetails() (+3 more)
...
Cohesion: 0.19
Nodes (16): getToken(), InviteScreen(), MembersScreen(), roles, HouseholdRole, useAcceptHouseholdInvitation(), useCreateHouseholdInvitation(), useDeclineHouseholdInvitation() (+8 more)

### Community 48 - "AuthProvider.tsx"
Cohesion: 0.16
Nodes (12): SettingsScreen(), backup, mockedBackupService, mockedUseAuth, useExportHouseholdBackup(), useImportHouseholdBackup(), useUpdatePreferredCurrency(), AuthContext (+4 more)
...
Cohesion: 0.29
Nodes (12): buildSelectionMap(), getAccountSummary(), SavingsScreen(), useRecurringTransactions(), useCreateSavingPot(), useDeleteSavingPot(), useSavingPotAccountAssignments(), useSavingPotBalances() (+4 more)
...
### Community 91 - "diagnostics.tsx"
Cohesion: 0.23
Nodes (10): DiagnosticItem, DiagnosticRow(), DiagnosticsScreen(), DiagnosticStatus, maskSecret(), styles, Section(), isSystemAdminEmail() (+2 more)
...
### Community 93 - "AttachmentsRepository"
Cohesion: 0.20
Nodes (4): AttachmentsRepository, createClient(), createQuery(), QueryResult
...
Cohesion: 0.39
Nodes (7): ruleKindOf(), TransfersScreen(), useCreateRecurringTransaction(), useDeleteRecurringTransaction(), useRecurringExecutionHistory(), useToggleRecurringTransaction(), useUpdateRecurringTransaction()

## Knowledge Gaps
- **462 isolated node(s):** `config`, `parameters`, `{ timingSafeEqual }`, `name`, `slug` (+457 more)
...
- **Why does `useTheme()` connect `index.ts` to `useAuth`, `index.ts`, `google-sign-in-button.tsx`, `app-tabs.web.tsx`, `RootProvider.tsx`, `transfers.tsx`, `settings.tsx`, `index.tsx`, `grouped-account-select.tsx`, `useTheme`, `CategoriesService`, `selection-shell.tsx`, `requireIdFor`, `grouped-destination-select.tsx`, `accounts.service.ts`, `accounts.service.ts`, `members.tsx`, `AuthProvider.tsx`, `SavingsScreen`, `diagnostics.tsx`, `transfers.tsx`?**
