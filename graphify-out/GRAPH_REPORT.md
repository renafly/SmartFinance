...
## Corpus Check
- 261 files · ~141,459 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1257 nodes · 2753 edges · 93 communities (73 shown, 20 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c735261`
...
### Community 0 - "useAuth"
Cohesion: 0.13
Nodes (31): AccountLike, BudgetScreen(), buildPotNameByAccountId(), createDefaultIncomeDrafts(), formatMonthSelection(), getMemberAccentColor(), getMemberLabel(), getSectionBadgeIcon() (+23 more)
...
Cohesion: 0.10
Nodes (10): useAccountsWithBalances(), AccountIdInput, AccountsService, CreateAccountInput, UpdateAccountInput, Account, CreateAccountDTO, NewAccount (+2 more)

### Community 3 - "Database"
Cohesion: 0.09
Nodes (22): CreateRecurringTransactionInput, Frequency, RuleKind, TransactionType, UpdateRecurringTransactionInput, Account, AccountBalance, Attachment (+14 more)

### Community 4 - "RepoResult"
Cohesion: 0.08
Nodes (4): RepoResult, HouseholdsRepository, MonthlyBudgetRepository, SavingPotsRepository
...
Cohesion: 0.12
Nodes (22): Account, BudgetConfig, BudgetHouseholdSettings, BudgetRule, DestinationKind, findHighestCashAccount(), getCashAccountIds(), getExcludedMonths() (+14 more)

### Community 7 - "index.ts"
Cohesion: 0.14
Nodes (16): AccountsScreen(), useArchiveAccount(), useCreateAccount(), useDeleteAccount(), useUpdateAccount(), useDefaultHousehold(), useMyHouseholds(), useSetDefaultHousehold() (+8 more)
...
Cohesion: 0.06
Nodes (31): @vercel/speed-insights, NOTE: Provider composition (Theme, Query, Auth, Localization, Feature, RootStack(), VercelSpeedInsights(), resources, useNotifications(), NotificationsService, FeatureFlagContext (+23 more)
...
Cohesion: 0.07
Nodes (30): AccountGroup, AccountGroupView, AccountOption, buildAccountGroups(), buildSelectionMap(), createStyles(), getAccountSummary(), PotDraft (+22 more)
...
Cohesion: 0.14
Nodes (35): AccountHistoryMode, accountTypes, createStyles(), currencyOptions, EditMode, AllocationDonut(), AttachmentDraft, createStyles() (+27 more)

### Community 16 - "settings.tsx"
Cohesion: 0.10
Nodes (30): CategoryEditDraft, categoryIconSuggestions, CategoryLike, types, DiagnosticItem, DiagnosticRow(), DiagnosticsScreen(), DiagnosticStatus (+22 more)

### Community 17 - "monthly-budget.repository.ts"
Cohesion: 0.07
Nodes (25): MemberProfile, CreateInvitationInput, createInviteLinks(), HouseholdRole, InvitationDetails, normalizeInviteWebBase(), AppNotification, BudgetConfig (+17 more)

### Community 18 - "index.tsx"
Cohesion: 0.18
Nodes (12): getToken(), InviteScreen(), Button(), ButtonProps, CardProps, FieldProps, formatDate(), PageProps (+4 more)

### Community 19 - "HouseholdsService"
Cohesion: 0.11
Nodes (21): currencyOptions, languageOptions, SettingsScreen(), themeOptions, backup, mockedBackupService, mockedUseAuth, useExportHouseholdBackup() (+13 more)
...
Cohesion: 0.11
Nodes (16): PublicLayout(), AnimatedIcon(), AnimatedSplashOverlay(), glowKeyframe, keyframe, logoKeyframe, styles, AppTabs() (+8 more)
...
Cohesion: 0.18
Nodes (10): BadgeProps, BadgeTone, EmptyStateProps, MetricCardProps, styles, TableCellProps, TableColumn, TableColumnsContext (+2 more)
...
Cohesion: 0.10
Nodes (18): DatePickerField(), formatDateInput(), frequencies, Frequency, months, MovementDraft, MovementFields(), MovementKind (+10 more)
...
Cohesion: 0.18
Nodes (20): MembersScreen(), roles, getTransactionTypeIcon(), TransactionsScreen(), useTopLevelCategories(), HouseholdRole, useAcceptHouseholdInvitation(), useCreateHouseholdInvitation() (+12 more)
...
Cohesion: 0.12
Nodes (5): AttachmentsRepository, BaseRepository, createClient(), createQuery(), QueryResult
...
- **Why does `useTheme()` connect `invalidateHouseholdData` to `useAuth`, `CategoriesRepository`, `index.ts`, `google-sign-in-button.tsx`, `app-tabs.web.tsx`, `RootProvider.tsx`, `transfers.tsx`, `members.tsx`, `settings.tsx`, `index.tsx`, `HouseholdsService`, `grouped-account-select.tsx`, `useTheme`, `households.repository.ts`, `CategoriesService`, `requireIdFor`, `session.types.ts`, `index.ts`?**
