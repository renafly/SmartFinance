...
function createStyles(colors: any) {
  return StyleSheet.create({
    ...
    pillText: { color: colors.textSecondary, fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.bold },
    pillTextActive: { color: colors.primaryForeground, fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.bold },
    xAxisRow: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: spacing(0.5) },
    xAxisLabel: { color: colors.textSecondary, fontSize: typography.fontSize[12], minWidth: spacing(6), textAlign: 'center' },
    ...
    legendShowAll: { color: colors.link, fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.bold },
    ...
    breakdownCaption: { color: colors.textSecondary, fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.regular },
    ...
    breakdownSectionChange: { fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.semibold, fontVariant: ['tabular-nums'] },
    breakdownRow: {
      flexDirection: 'row',
      alignItems: 'center',
    ...
    goalCaptionLine: { fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.semibold },
    ...
    breakdownRowChange: { fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.semibold, fontVariant: ['tabular-nums'] },
    breakdownTotalRow: {
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'space-between',
    ...
    rowsToggleText: { color: colors.textSecondary, fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.semibold },
    ...
    seriesRowSubLabel: { color: colors.textSecondary, fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.regular },
    ...
    seriesRowChange: { fontSize: typography.fontSize[12], fontWeight: typography.fontWeight.semibold, fontVariant: ['tabular-nums'] },
